# Description: This PowerShell script creates a directory structure for storing online course materials. 
#              It handles path validation and can automate the creation of multiple README.md files. 
# Script Name: create_online_courses_directory_structure.ps1

$folders = @(
    "README.md",
    "Course1\Lecture1.md",
    "Course1\Notes",
    "Course1\OS_Environment"
)
