# Description: This PowerShell script creates a directory structure for storing project files. 
#              It handles path validation and can automate the creation of multiple README.md files. 
# Script Name: create_my_project_directory_structure.ps1
...
''' The rest of the directory if you did not download the Git Hub repository
CoreFeetConcepts\Notes\Building_A_Measurements.md",
"CoreFeetConcepts\Notes\Environment_Conditions.md",
"CoreFeetConcepts\Ideas\Future_Scripts\Python_Server_Script.py",
"CoreFeetConcepts\Implemented_Scripts",
"CoreFeetConcepts\Implemented_Structures\Activity",
"CoreFeetConcepts\Implemented_Structures\Event",
"CoreFeetConcepts\Implemented_Structures\Website",
"CoreFeetConcepts\Metadata_Templates",
"CoreFeetConcepts\Programming_Languages\Python\utility.md",
"CoreFeetConcepts\Programming_Languages\PowerShell\utility.md",
"CoreFeetConcepts\OS_Environmnet",
"CoreFeetConcepts\README.md"
'''
