# Description: This PowerShell script creates a directory structure for storing equipment notes. 
#              It handles path validation and can automate the creation of multiple README.md files. 
# Script Name: create_equipment_notes_directory_structure.ps1

$folders = @(
    "README.md",  
    "Racks",
    "Desks",
    "Building_Properties\Building_A.md",
    "Building_Properties\Data_Center_A.md",
    "Building_Properties\Building_A",
    "Building_Properties\Data_Center_A",
    "Hallways",
    "Inventory",
    "SilverFox",
    "SilverFox_Laptop\Installation_Logs",
    "SilverFox_Laptop\OS_Environments",
    "SilverFox_Laptop\PATH_Variable_Snapshots",
    "SilverFox_Laptop\Software_Installers"
)
